...
- binsegRcpp multiset and ruptures are asymptotically faster than binsegRcpp list.
...
- Very little difference between Laplace (log-linear) and others (linear).
